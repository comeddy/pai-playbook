...
_最終更新: 2026-08 · owner: Youngjin · volatility: 高（バージョン・インスタンスが頻繁に変わる）_
...
---
_owner: Youngjin · updated: 2026-08 · volatility: 高（バージョン・インスタンスは折りたたみブロックで管理）· sources: [1] 公式/論文, [3] ベンダー, [4] 未検証。GitHub リリースの年の一部は再確認を推奨。_
