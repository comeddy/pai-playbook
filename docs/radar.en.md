...
## 🆕 Latest scan intake (2026-07-28 · primary verification completed 2026-07-21)
...
| **Samsung RX humanoid robotics division** (led by ex-Hyundai Motor Group/Boston Dynamics EVP Lee Dong-kun) | ⚪ Hype/roadmap | Confirmed by Samsung `[1]` (2026-07-21, RX division launched directly under CEO TM Roh) — plans for R&D hubs in the US, China, and Japan. "13 trillion won (~$13B)" investment and "robot-brain AI already tested in factories" are secondary-source claims only `[4]`, no primary confirmation from Samsung. No product or production roadmap disclosed; no AWS connection mentioned | Public product/production roadmap + confirmed cloud/AWS infrastructure connection |
