...
## 🆕 최신 스캔 유입 (2026-08-28 · 1차 검증 완료 2026-07-21)
...
| **[Generative Bionics GENE.01](https://gbionics.ai/gene01/)** (Italian Institute of Technology 스핀아웃, 풀바디 촉각 스킨 휴머노이드 플랫폼) | 🟡 Preview | ✨ **주목**: IIT 20년 연구를 스핀아웃(2024)한 이탈리아 스타트업이 6개월 만에 완성 — 접촉·온도·근접·힘을 감지하는 풀바디 분산 촉각 스킨 + "physics-native AI"로 사람과의 안전 협업을 노리는 산업용 플랫폼, Fincantieri(조선) 실산업 파일럿까지 확보<br>⏳ **대기**: 공식 발표(2026-07, AMD Advancing AI 2026 데뷔) `[4]` — 디지털 트윈 기술 사양은 공개했으나 실배포·자율 성능 독립 검증 없음, Fincantieri 협업은 초기 단계 | Fincantieri 파일럿 결과 공개 + 독립 검증 |
