...
## 🆕 최신 스캔 유입 (2026-09-09 · 1차 검증 완료 2026-07-21)
...
| **[XPeng Robotics IRON](https://www.xpeng.com/pressroom/news/01a03797fccda01e0de68a02a256006a)** (9억 달러+ 단독 라운드, 63억 달러 밸류에이션) | ⚪ 로드맵 | ✨ **주목**: 중국 임바디드 AI 업계 사상 최대 단일 라운드 민간 투자(IDG Capital 주도, Tencent·Alibaba 전략 참여) — 휴머노이드 경쟁 지형의 자금력 기준점을 다시 옮기는 신호, 고객 대화에서 경쟁사 벤치마크로 인용 가능<br>⏳ **대기**: XPeng 공식 발표(2026-08-24) `[4]` — 연내(2026) "양산" 목표는 자사 매장·캠퍼스 내 초기 상용 배치이고, 중국·해외 고객 대상 정식 출시·배송은 2027년부터. 현재 실가동 0, 3자 검증 없음. ⚠️ 이번 실행 환경 egress 제한으로 curl 200 수동 검증 미수행(커밋 메시지·이슈 참조) | 양산 개시 확인 + 실가동 사례 공개 |
