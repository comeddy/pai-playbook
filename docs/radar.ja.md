---
ko_hash: 3c5bdc026b9dc4375425943bc503843f58f2cd2b
---
# Radar — キュー / ウォッチリスト
...
## 🆕 最新スキャン流入（2026-08-28 · 一次検証完了 2026-07-21）
...
| **[Generative Bionics GENE.01](https://gbionics.ai/gene01/)**（Italian Institute of Technology スピンアウト、全身触覚スキンヒューマノイドプラットフォーム） | 🟡 Preview | ✨ **注目**: IIT の 20 年の研究からスピンアウト（2024 年）したイタリアのスタートアップがわずか 6 ヶ月で完成 —— 接触・温度・近接・力を検知する全身分散型触覚スキン + 「physics-native AI」で人との安全な協働を狙う産業向けプラットフォーム、Fincantieri（造船）との実産業パイロットも確保<br>⏳ **待機**: 公式発表（2026-07、AMD Advancing AI 2026 でデビュー）`[4]` —— デジタルツインの技術仕様は公開したが実展開・自律性能の独立検証はなし、Fincantieri との協業はまだ初期段階 | Fincantieri パイロット結果の公開 + 独立検証 |
