...
_최종 갱신: 2026-09 · owner: Youngjin · 상태: 초기 구축 중_
...
!!! info "비공식 자료 (Unofficial)"
    이 사이트는 개인이 운영하는 참조 자산으로, **AWS(Amazon Web Services)의 공식 문서·공식 입장이 아니다.** 이 사이트의 서비스 사양·가격·리전 지원은 반드시 [AWS 공식 문서](https://docs.aws.amazon.com/)에서 재확인합니다.
-->
...
5. **최근 자료를 찾으면**: [새 소식](news.md)에서 공식 발표·고객 기술 글을, [워크숍·자료](workshops.md)에서 목적별 실습·구현 자료를 확인한다.
...
_owner: Youngjin · updated: 2026-09 · volatility: 낮음 (구조 페이지 — FAQ Top 20 순위만 분기별 재검토)_
