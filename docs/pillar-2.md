...
**🔗 관련 자산**: [pillar-3 시뮬레이션(Isaac Lab)](pillar-3.md) · [decisions: GPU 확보](decisions.md) · [Physical AI E2E 워크샵 (한국어 — GR00T VLA 파인튜닝 + SageMaker 트랙)](https://hi-space.gitbook.io/physical-ai-on-aws/guide/e2e-workshop)
