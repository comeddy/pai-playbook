...
**🔗 관련 자산**: [pillar-4 엣지](pillar-4.md) · [AgentCore 시작 워크샵](https://catalog.workshops.aws/agentcore-getting-started/en-US) — 라이브 확인 필요 ⚠️ · [AgentCore Deep Dive 워크샵](https://catalog.workshops.aws/agentcore-deep-dive/en-US) — 라이브 확인 필요 ⚠️ · (사내 AgentCore 워크숍 — 확인 필요 ⚠️)
