...
## 🆕 最新扫描流入（2026-08-28 · 一手验证完成 2026-07-21）
...
| **[Generative Bionics GENE.01](https://gbionics.ai/gene01/)**（Italian Institute of Technology 分拆公司，全身触觉皮肤人形机器人平台） | 🟡 Preview | ✨ **关注**：意大利公司基于 IIT 20 年研究成果分拆（2024）成立，仅用 6 个月完成 —— 可感知触摸·温度·接近·力的全身分布式触觉皮肤 + "physics-native AI"，瞄准工业场景下与人类的安全协作，已获得 Fincantieri（造船）的实际工业试点<br>⏳ **待定**：官方发布（2026-07，于 AMD Advancing AI 2026 首发）`[4]` —— 已公开数字孪生技术规格，但实际部署·自主性能尚无独立验证，与 Fincantieri 的合作仍处早期阶段 | 公开 Fincantieri 试点结果 + 独立验证 |
