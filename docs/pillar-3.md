...
_최종 갱신: 2026-07 · owner: 미정 ⚠️ · volatility: 높음(버전·인스턴스가 자주 바뀜)_
...
---
_owner: 미정 ⚠️ · updated: 2026-07 · volatility: 높음 (버전·인스턴스는 접힌 블록에서 관리) · sources: [1] 공식/논문, [3] 벤더, [4] 미검증. GitHub 릴리스 연도 일부 재확인 권고._
